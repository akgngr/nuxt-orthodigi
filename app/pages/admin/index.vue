      ...
      <div class="space-y-8">
        ...
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 to-indigo-700 p-8 text-white shadow-2xl">
          <div class="relative z-10 max-w-2xl">
            <h1 class="text-3xl font-bold mb-2">Hoş geldin, Dr. Ortho! 👋</h1>
            <p class="text-primary-100 text-lg">Bugün için 8 aktif randevunuz ve incelenmeyi bekleyen 12 yeni mesajınız var.</p>
          </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <UCard class="lg:col-span-2 shadow-sm border-none bg-white dark:bg-gray-900 overflow-hidden" :ui="{ header: 'border-b-0 px-8 py-6', body: 'p-0' }">
            <template #header>
              <div class="flex items-center justify-between">
                <div>
                  <h3 class="text-xl font-bold text-gray-900 dark:text-white">Son Kayıtlar</h3>
                  <p class="text-sm text-gray-500">Platforma son katılan kullanıcıların listesi.</p>
                </div>
                <UButton variant="subtle" color="neutral" size="sm" class="rounded-lg">Tümünü Gör</UButton>
              </div>
            </template>
          ...
          <!-- Quick Actions -->
          <div class="space-y-6">
            <UCard class="shadow-sm border-none bg-white dark:bg-gray-900" :ui="{ header: 'border-b-0 px-8 py-6' }">
              <template #header>
                <h3 class="text-xl font-bold">Hızlı İşlemler</h3>
              </template>
              <div class="grid grid-cols-1 gap-3">
                <UButton icon="i-lucide-user-plus" label="Yeni Kullanıcı Ekle" block variant="outline" color="neutral" class="justify-start py-3 px-4 rounded-xl hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-950" />
                <UButton icon="i-lucide-calendar" label="Randevu Oluştur" block variant="outline" color="neutral" class="justify-start py-3 px-4 rounded-xl hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-950" />
                <UButton icon="i-lucide-file-text" label="Rapor Oluştur" block variant="outline" color="neutral" class="justify-start py-3 px-4 rounded-xl hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-950" />
                <UButton icon="i-lucide-mail" label="E-posta Gönder" block variant="outline" color="neutral" class="justify-start py-3 px-4 rounded-xl hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-950" />
              </div>
            </UCard>

            <UCard class="bg-indigo-900 text-white border-none shadow-xl overflow-hidden relative">
              <div class="relative z-10">
                <h4 class="font-bold text-lg mb-2">Pro Versiyona Geçin</h4>
                <p class="text-indigo-200 text-sm mb-4">Daha fazla özellik ve sınırsız raporlama için yükseltme yapın.</p>
                <UButton color="neutral" variant="outline" block class="bg-white text-indigo-900 font-bold hover:bg-white/90 border-none">Yükselt</UButton>
              </div>
